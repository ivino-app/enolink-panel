                        ...
                        <div key={wine.id} className={`text-center p-4 rounded-xl shadow-lg w-60 ${i === 0 ? "border-2 border-red-800" : ""}`}>
                            ...
                            {wine.image && (
                                <div className="w-16 h-24 mx-auto mb-2 relative">
                                    <img src={wine.image} alt={wine.name} className="w-full h-full object-contain" onError={(e) => (e.currentTarget.style.display = "none")} />
                                </div>
                            )}
                            ...
                            <div className={`mt-2 text-white font-bold rounded-full px-4 py-1 w-fit mx-auto ${i === 0 ? "bg-red-800" : i === 1 ? "bg-gray-400" : "bg-orange-300"}`}>
                                #{i + 1}
                            </div>
                        </div>
                    ))}
